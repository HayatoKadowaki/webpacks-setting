export default class Tab {
    constructor(props) {
        this.targets = this.checkElementError(document.querySelectorAll(props.target));
        this.contents = this.checkElementError(document.querySelectorAll(props.content));
